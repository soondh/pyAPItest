...
#俱乐部id不存在
class T105_ClubItem_00NormalTest(ApiTestSuit):
    """API接口测试类T105_ClubItem_00NormalTest"""
    ...
    def setUp(self):
        ...
        self.sub_class_name = T105_ClubItem_00NormalTest.__name__
        self.testure_path = r"testure/T105_ClubItem_00NormalTest.csv"
        self.config_path = r'''../config.properties'''
        self.logger = logging.getLogger(self.__class__.__name__)
        self.env_setup()
        self.initConfig()
        self.regist_func(self.testT105_ClubItem_00Normal)
        ################################################################################
    def env_setup(self):
        """
        ...
        curr_path = os.getcwd()
        with open(curr_path + r'\testure\T105_ClubItem_00NormalTest.csv','w',encoding='utf-8') as f:
            f_csv = csv.writer(f)
