...
#创建成功
class T101_ClubCreate_00NormalTest(ApiTestSuit):
    """API接口测试类T101_ClubCreate_00NormalTest"""
    ...
    def setUp(self):
        ...
        self.sub_class_name = T101_ClubCreate_00NormalTest.__name__
        self.testure_path = r"testure/T101_ClubCreate_00NormalTest.csv"
        self.config_path = r'''../config.properties'''
        self.logger = logging.getLogger(self.__class__.__name__)
        self.env_setup()
        self.initConfig()
        self.regist_func(self.testT101_ClubCreate_00Normal)
        ################################################################################
    def env_setup(self):
        """
        :return:
        ...
        rows = [('01', '', 'true', 1, 'post', '/club/create?', 200, 0, user_id, str1 + '00', 1, 1, 'heihei', '浙江省', '杭州市', '西湖区',
                 '18758113455')
                ]

        curr_path = os.path.dirname(__file__)
        with open(curr_path + r'/testure/T101_ClubCreate_00NormalTest.csv','w',encoding='utf-8') as f:
            f_csv = csv.writer(f)
    ...
    def testT101_ClubCreate_00Normal(self):
        """
