...
#创建过同类型俱乐部
class T101_ClubCreate_03NormalTest(ApiTestSuit):
    """API接口测试类T101_ClubCreate_03NormalTest"""
    ...
    def setUp(self):
        ...
        self.sub_class_name = T101_ClubCreate_03NormalTest.__name__
        self.testure_path = r"testure/T101_ClubCreate_03NormalTest.csv"
        self.config_path = r'''../config.properties'''
        self.logger = logging.getLogger(self.__class__.__name__)
        self.env_setup()
        self.initConfig()
        self.regist_func(self.testT101_ClubCreate_03Normal)
        ################################################################################
    def env_setup(self):
        """
        ...
        rows = [('01', '', 'true', 1, 'post', '/club/create?', 200, 0, user_id, str1 + '31', 1, 1, 'heihei','浙江省','杭州市','西湖区',
                 '18758113455'),
                ('02', '', 'true', 1, 'post', '/club/create?', 200, 4, user_id, str1 + '32', 1, 1, 'heihei','浙江省','杭州市','西湖区',
                 '18758113455')
                ]

        curr_path = os.path.dirname(__file__)
        with open(curr_path + r'\testure\T101_ClubCreate_03NormalTest.csv','w',encoding='utf-8') as f:
            f_csv = csv.writer(f)
    ...
    def testT101_ClubCreate_03Normal(self):
        """
