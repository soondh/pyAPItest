...
#用户加入1个俱乐部
class T103_UserJoinClub_01NormalTest(ApiTestSuit):
    """API接口测试类T103_UserJoinClub_01NormalTest"""
    ...
    def setUp(self):
        ...
        self.sub_class_name = T103_UserJoinClub_01NormalTest.__name__
        self.testure_path = r"testure/T103_UserJoinClub_01NormalTest.csv"
        self.config_path = r'''../config.properties'''
        self.logger = logging.getLogger(self.__class__.__name__)
        self.env_setup()
        self.initConfig()
        self.regist_func(self.testT103_UserJoinClub_01Normal)
        ################################################################################
    ...
    def env_setup(self):
        ...
        test_script.run_test_class(case_name=["T602_ApplicationCheck_00NormalTest"])
        ...
        with open(curr_path + r'\testure\T103_UserJoinClub_01NormalTest.csv', 'w', encoding='utf-8') as f:
            f_csv = csv.writer(f)
    ...
    def testT103_UserJoinClub_01Normal(self):
        """
